<!-- MODAL-->
<div id="addRemarkModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        <!-- MODAL Content -->
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            <!-- MODAL Header-->
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Add Remark</h3>
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-target="addRemarkModal" data-modal-toggle="addRemarkModal">
            ...
            <form method="POST" id="addRemarkForm">
                ...
                <div class="grid grid-cols mt-4 gap-4">
                    <div class=" text-white">
                        ...
                        <x-Input-TextArea id="question" class="block mt-1 w-full"
                            name="Question"
                            :value="old('Question')"
                            required />
                    </div>
                ...
                <div class="grid grid-cols mt-4 gap-4">
                    <div class=" text-white">
                        ...
                        <x-Input-TextArea id="placeholder" class="block mt-1 w-full"
                            name="PlaceHolder"
