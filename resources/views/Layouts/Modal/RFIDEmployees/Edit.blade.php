    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Edit RFID</h3>
            ...
            <form method="POST" id="editExamineeSchedForm">
                ...
                <div class="flex flex-col items-center pb-8 px-5 md:px-10">
                    ...
                    <img id="i_photo" class="w-24 h-24 md:w-32 md:h-32 mb-3 rounded-full shadow-xl ring-1 ring-gray-300 mx-auto" alt="Employee Photo">
                    ...
                    <div class="w-full mt-10 mx-2 ">
                        ...
                        <div class="relative">
                            <input type="number" name="rfid" id="e_rfid" class="block p-4 w-full text-md text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
