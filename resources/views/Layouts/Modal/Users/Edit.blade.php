            ...
            <form method="POST" id="editUserForm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 mt-4 gap-4">
                    <div class=" text-white">
                        <x-Input-Label for="e_name">Full Name</x-Input-Label>
                        <x-Input-Field id="e_name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required   />
                    </div>
                    <div class=" text-white">
                        <x-Input-Label for="e_email">Email Address</x-Input-Label>
                        <x-Input-Field id="e_email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required  />
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 mt-4 gap-4">
                    <div class=" text-white">
                        <x-Input-Label for="e_type">Account Type</x-Input-Label>
                        <x-Input-Dropdown name="type" id="e_type">
