...
<div class="max-w-xl lg:max-w-3xl w-full h-full  bg-white border-2 rounded-lg shadow dark:bg-gray-800 p-4 md:p-6 dark:border-gray-500">
    <div class="flex justify-between mb-3">
        <div class="flex justify-center items-center">
            <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white pe-1">Employees Gender</h5>
    ...
    <!-- Donut Chart -->
    <div class="py-6" id="employee-pie"></div>
...
@push('scripts')
    ...
    <script>
       document.addEventListener('DOMContentLoaded', function () {
            axios.get('{{ route('api.dashboard.genderEmployee') }}')
                .then(response => {
                    const gender = response.data;
                    renderEmployeePie(gender);
        ...
        function renderEmployeePie(gender) {
            const femaleData = gender.EmployeeFemaleCurrent;
            const maleData = gender.EmployeeMaleCurrent;
            ...
            if (document.getElementById("employee-pie") && typeof ApexCharts !== 'undefined') {
                const chart = new ApexCharts(document.getElementById("employee-pie"), option);
                chart.render();
