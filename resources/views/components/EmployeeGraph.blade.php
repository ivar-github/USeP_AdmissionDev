<div class="max-w-xl lg:max-w-3xl w-full h-full border-2 dark:border-gray-500 rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
    <div class="flex justify-between pb-4 mb-4 border-b border-gray-200 dark:border-gray-500">
        <div class="flex items-center">
            <div class="w-12 h-12 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center me-3">
                ...
                <div>
                <h5 class="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-1">Employees</h5>
                <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Employees with RFID last ten terms</p>
            </div>
        </div>
        <div>
