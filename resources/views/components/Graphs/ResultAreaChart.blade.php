    ...
    <div class="flex justify-between border-b border-gray-200 dark:border-gray-500 pb-2">
        <div class="flex items-center">
            <div class="w-12 h-5 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center me-3">
                ...
                <div>
                <h5 class="leading-none text-sm font-bold text-gray-900 dark:text-white ">Line Graph Analytics</h5>
...
@push('scripts')
    <script>
        ...
        function renderAreaChart(data) {
            ...
            const options = {
                colors: ["#E3A008", "#F98080", "#31C48D", "#76A9FA"],
                series: [
                    {
                        name: "Total",
                        color: "#76A9FA",
            ...
            if(document.getElementById("chart-Area") && typeof ApexCharts !== 'undefined') {
                const chart = new ApexCharts(document.getElementById("chart-Area"), options);
                chart.render();
            }
        }
    </script>
