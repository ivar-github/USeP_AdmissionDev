    ...
    <div class="flex justify-between border-b border-gray-200 dark:border-gray-500 pb-2">
        <div class="flex items-center">
            <div class="w-12 h-5 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center me-3">
                ...
                <div>
                    <h5 class="leading-none text-sm font-bold text-gray-900 dark:text-white ">Vertical Bar Graph Analytics</h5>
...
@push('scripts')
    <script>
        ...
        function renderVerticalBar(data) {
            ...
            if(document.getElementById("chart-VerticalBar") && typeof ApexCharts !== 'undefined') {
                const chart = new ApexCharts(document.getElementById("chart-VerticalBar"), options);
                chart.render();
            }
        }
    </script>
