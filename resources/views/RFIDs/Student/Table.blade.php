<x-Main-layout>
    <div class="py-5 ">
        ...
        {{-- <table id="Tabledata" class="w-full text-xs md:text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                @foreach ($students as $student)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <th scope="row" class="flex items-center px-2 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                            <img class="w-10 h-10 rounded-full" src="{{ $student->StudentPicture_base64 ? $student->StudentPicture_base64 : asset('img_assets/avatar.png') }}" alt="Image">
                            <div class="ps-3">
                                <div class="text-base font-semibold">
                                    {{ $student->Prefix }} {{ $student->LastName }}, {{ $student->FirstName }} {{ $student->Middlename }}
                                </div>
                        ...
                        <td class="px-1 py-4 space-x-1 inline-flex items-center">
                            <a href="{{ route('students.show', $student->StudentNo)}}" class="font-medium text-gray-600 dark:text-gray-400 hover:underline">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg py-5 px-2">
                <div class="p-6 md:p-10 text-gray-900 dark:text-gray-100  ">
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Student Number, Full Name, Email Address, SmartCard ID and Status.
                    </p>
                                ...
                                <tbody>
                                    @foreach ($students as $student)
                                        <tr>
                                            ...
                                            <td>
                                                <img class="w-10 h-10 rounded-full" src="{{ $student->StudentPicture_base64 ? $student->StudentPicture_base64 : asset('img_assets/avatar.png') }}" alt="Image" style="vertical-align: middle; display: inline-block;">
