                ...
                <div class=" max-w-md mx-auto m-5  bg-white border border-gray-200 rounded-xl shadow-xl dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="flex flex-col items-center pb-8 px-5 md:px-10">
                        ...
                        <div class="w-full mt-10 mx-2 ">
                            <div class="relative">
                                <input type="number" name="smartID" value="{{ $employeesRFID->SmartCardID }}" id="smartID" class="block px-2.5 p-4 w-full text-md text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " disabled/>
                        ...
                        <div class="flex mt-4 md:mt-6">
                            @if(session('success'))
                                <a href="{{ route('employeesRFIDs.index')}}" class="inline-flex items-center px-8 py-2 text-sm font-medium text-center shadow-lg text-gray-200  bg-blue-800 hover:bg-blue-700 hover:text-gray-200 rounded-lg  focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-800 dark:hover:bg-blue-700 dark:focus:ring-blue-800">DONE</a>
                            @else
                                <a href="{{ route('employeesRFIDs.edit', $employeesRFID->EmployeeID)}}" class="inline-flex items-center px-8 py-2 text-sm font-medium text-center shadow-lg text-gray-200  bg-blue-800 hover:bg-blue-700 hover:text-gray-200 rounded-lg  focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-800 dark:hover:bg-blue-700 dark:focus:ring-blue-800">EDIT</a>
                            @endif
                        </div>
                    </div>
                </div>
