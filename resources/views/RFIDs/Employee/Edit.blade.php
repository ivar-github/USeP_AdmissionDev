                    ...
                    <form method="POST" action="{{ route('employees.update', $employee->EmployeeID)}}">
                        ...
                        <div class="flex flex-col items-center pb-8 px-5 md:px-10">
                            ...
                            <div class="w-full mt-10 mx-2 ">
                                ...
                                <div class="relative">
                                    <input type="number" name="smartcardid" value="{{old('smartcardid', $employee->SmartCardID )}}" id="smartcardid" class="block p-4 w-full text-md text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                            ...
                            <div class="flex mt-4 md:mt-6 space-x-10">
                                <a href="{{ route('employees.index')}}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center shadow-lg text-gray-800  bg-yellow-400 hover:bg-yellow-300 hover:text-gray-700 rounded-lg  focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-yellow-400 dark:hover:bg-yellow-300 dark:focus:ring-blue-800">CANCEL</a>
