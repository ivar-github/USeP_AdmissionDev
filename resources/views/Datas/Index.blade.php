        ...
        <div class="overflow-hidden py-5">
            ...
            <div class="mb-4">
                ...
                <div class="flex gap-2">
                    ...
                    @foreach(['EmployeeID', 'Gender', 'NationalityID'] as $column)
                        <label class="inline-flex items-center">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function renderGenderCounts(counts) {
                ...
                if (selectedGender === 'M') {
                    genderCountsContainer.innerHTML = `
                        <div class="bg-blue-500 text-white rounded-lg shadow-md p-6 flex-1">
                            <div class="flex items-center">
                                ...
                                <!-- Text Content -->
                                <div class="ml-4">
                                    <h2 class="text-lg font-semibold">Male Users</h2>
                    ...
                    genderCountsContainer.innerHTML = `
                        <div class="bg-pink-500 text-white rounded-lg shadow-md p-6 flex-1">
                            <div class="flex items-center">
                                <!-- Icon for Female -->
                                <div class="p-2 bg-pink-700 rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                ...
                                <!-- Text Content -->
                                <div class="ml-4">
                                    <h2 class="text-lg font-semibold">Female Users</h2>
            ...
            function renderTable(data, currentPage, limit) {
                ...
                tableHTML += '<th class="py-2 px-4 border">#</th>'; // Row number header
                ...
                data.forEach((row, index) => {
                    let rowNumber = (currentPage - 1) * limit + index + 1; // Calculate row number
                    tableHTML += `<tr><td class="py-2 px-4 border">${rowNumber}</td>`; // Row number cell
                    selectedColumns.forEach(column => {
                        if (column === 'Gender') {
                            tableHTML += `<td class="py-2 px-4 border">${row[column] === 'M' ? 'Male' : 'Female'}</td>`; // Convert M/F to Male/Female
                        } else {
