                                ...
                                @foreach ($statements as $statement)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 text-sm">
                                        ...
                                        <td scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                            <div class="ps-3">
                                                <div class="font-semibold max-w-[24rem] truncate">{{ $statement->statement }}</div>
                                                <div class="font-normal text-gray-500">{{ $statement->desc }}</div>
                                            </div>
                                        </td>
                                        <td>
                                            {{ $statement->sortOrder }}
            ...
            function openEditModal(statementId) {
                axios.get(`/courseEvalStatements/${statementId}/edit`)
                    .then(response => {
                        ...
                        document.getElementById('e_versionID').value = item.versionID;
                        document.getElementById('e_ratingTempID').value = item.ratingTemplateID;
