...
Route::middleware(['auth', CheckUserStatus::class])->group(function () {
    ...
    // Route::resource('rfid/employeesRFIDs', RFIDEmployeeController::class)->where(['employeesRFIDs' => '.*']);
    Route::resource('rfid/employeesRFIDs', RFIDEmployeeController::class)
    ->where(['employeesRFIDs' => '[a-zA-Z0-9_]+']);

    // // Route::post('rfid/employee/search', [RFIDEmployeeController::class, 'search'])->name('employeesRFIDs.search');
    // Route::get('rfid/employee/search', [RFIDEmployeeController::class, 'indexb'])->name('employeesRFIDs.search');
    // Route::get('rfid/employee/table', [RFIDEmployeeController::class, 'table'])->name('employeesRFIDs.table');
    // Route::get('rfid/student/table', [RFIDStudentController::class, 'table'])->name('students.table');
    // Route::post('rfid/student/search', [RFIDStudentController::class, 'search'])->name('students.search');
