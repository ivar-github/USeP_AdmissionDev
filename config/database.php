...
return [
    ...
    */
    ...
    'connections' => [
        ...
        //     'database' => env('DB_DATABASE', 'dbcac'),
        ...
        'sqlsrv2' => [
            'driver' => 'sqlsrv',
            'host' => env('DB_HOST_PRISM', ''),
            'port' => env('DB_PORT_PRISM', ''),
            'database' => env('DB_DATABASE_PRISM', ''),
            'username' => env('DB_USERNAME_PRISM', ''),
            'password' => env('DB_PASSWORD_PRISM', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'encrypt' => 'yes',
            'trust_server_certificate' => true,
